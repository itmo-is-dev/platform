...
public readonly record struct CancellationBuilder
{
    public readonly record struct ResultBuilder
    {
        ...
        public ErrorBuilder<EmptyExecutionResult> ForEmptyResult() => new();
    }
        ...
        where TError : IBackgroundTaskError
    {
        ...
        {
            return new BackgroundTaskExecutionResult<TResult, TError>.Cancellation(builder.Error);
        }
    }
}