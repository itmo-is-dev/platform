...
public abstract class PlatformLifetimePostInitializerBase : IPlatformLifetimePostInitializer
{
    ...
    public async Task OnAfterInitializedAsync(CancellationToken cancellationToken)
    {
