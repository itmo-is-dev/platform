...
internal class MessagePersistencePublisher : IMessagePersistencePublisher
{
    ...
    public async Task PublishAsync(PersistedMessageModel[] messages, CancellationToken cancellationToken)
    {
    ...
    private string? GetNextBufferingStep(PersistedMessageModel message)
    {
