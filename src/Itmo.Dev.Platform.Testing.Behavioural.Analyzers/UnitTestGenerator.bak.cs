...
//             var constructor = new GeneratedTestConstructorSyntax(sourceTestSymbol, contextSymbol);
//
//             var generatedClassDeclaration = ClassDeclaration(sourceTestSymbol.Name)
//                 .AddModifiers(Token(SyntaxKind.PublicKeyword), Token(SyntaxKind.PartialKeyword))
//                 .AddAttributeLists(AttributeList().AddAttributes(new CollectionAttributeSyntax(contextSymbol).Value))
//                 .AddMembers(constructor.Declaration)
